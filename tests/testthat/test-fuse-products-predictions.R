...
test_that("fuse_products_predictions respects min_score when retaining products", {
  ...
  expect_equal(lb$weight[lb$product == "P1"], 0)
  expect_gt(lb$weight[lb$product == "P2"], 0)
